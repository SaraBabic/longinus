...
$settings['hash_salt'] = 'ynXHeoqEamxrlslTSDiOdnhLLpmtzJATQlhqITCKEuBrmyArfSGUtpSvBUbsEnsa';
...
* Local trusted host pattern:
$settings['trusted_host_patterns'] = [
   'localhost',
];

* Distant trusted host pattern:
$settings['trusted_host_patterns'] = [
   'https://sara.stud.vts.su.ac.rs/',
];
